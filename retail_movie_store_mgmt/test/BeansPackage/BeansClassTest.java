...
public class BeansClassTest {
    ...
    /**
     * Test of handleReportLogic method, of class BeansClass.
     */
    @Test
    public void testHandleReportLogic() {
        System.out.println("handleReportLogic");
        HandleReportLogic expResult = new HandleReportLogic();
        HandleReportLogic result = BeansClass.handleReportLogic();
        assertNotNull("Checking that HandleReportLogic object is not null",
                result);
        assertEquals("Should return HandleReportLogic class object",
                expResult.getClass(), result.getClass());
    }
