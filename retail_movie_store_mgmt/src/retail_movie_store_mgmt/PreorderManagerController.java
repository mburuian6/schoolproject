...
//        preorder = handlePreorderLogic.findOne(id);
    ...
    public void submitNewEntry(){
        ...
        if(customerName== null || pickupDate==null){
            ...
            String insert = handlePreorderLogic.insertPreorder(preorder);
            if(insert.contains("Error!Preorder has already been inserted")){
                displayError("Error!Preorder has already been inserted");
            }
    ...
    public void updateEntry(){
        ...
        if(customerName== null || pickupDate==null){
            ...
            String update = handlePreorderLogic.updatePreorder(preorder);
            if(update.contains("Error!Please contact support for help")){
                displayError("Error!Please contact support for help");
            }
            else if(update.contains("Successful Update!")){
    ...
    public void deleteEntry(){
        ...
        if(customerName== null || pickupDate==null){
            ...
            HandlePreorderLogic handlePreorderLogic = BeansClass.handlePreorderLogic();
            preorder = handlePreorderLogic.findOne(id);
            String delete = handlePreorderLogic.deletePreorder(preorder);
            if(delete.contains("Error!Please contact support for help")){
                displayError("Error!Please contact support for help");
            }
