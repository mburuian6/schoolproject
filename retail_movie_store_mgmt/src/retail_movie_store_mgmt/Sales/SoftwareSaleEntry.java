 ...
 * @author Ian Mburu
 */
public class SoftwareSaleEntry extends SaleEntry{
    String title;
    double price;
    int quantity;
    double sub_total;
    ...
    String saleProfile;
    Date date;
    public SoftwareSaleEntry(){
        
    }
    
    public SoftwareSaleEntry(String title, double price, int quantity, double sub_total, double sub_discount, double sub_netTotal) {
        this.title = title;
        this.price = price;
