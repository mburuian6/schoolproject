...
public class ProfileManagerController implements Initializable {
    ...
    public void deleteUser(){
        ...
        HandleProfileLogic handleProfileLogic = BeansClass.handleProfileLogic();
        String delete = handleProfileLogic.deleteUser(username);
        if(delete.contains("Error!Cannot delete admin account as it is primary")){
            displayError("Error!Cannot delete admin account as it is primary");
        }
        else if(delete.contains("Error!Cannot delete own account while logged in")){
            displayError("Error!Cannot delete own account while logged in");
        }
        else if(delete.contains("Error deleting!Please contact support for help")){
            displayError("Error deleting!Please contact support for help");
        }
        else if (delete.contains("Successful Deletion!")){
    ...
    public void addUser(){
        if(usernameField.getText()==null ||
            ...
            String insert = handleProfileLogic.insertUser(user);
            if(insert.contains("Error!User has already been inserted")){
                displayError("Error!User has already been inserted");
            }
            else if(insert.contains("Error Inserting!Please contact support for help")){
                displayError("Error Inserting !Please contact support for help");
            }
            else if(insert.contains("Successful Insertion")){
