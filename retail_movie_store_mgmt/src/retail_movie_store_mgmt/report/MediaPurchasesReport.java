 ...
 * @author Ian Mburu
 */
public class MediaPurchasesReport {

    Set<String> keys;
    JasperPrint jp;
    public HashMap getData(){
        HandleMediaPurchaseLogic handleMediaPurchaseLogic = BeansClass.handleMediaPurchaseLogic();
        LinkedHashMap <String,ArrayList> dateItems = handleMediaPurchaseLogic.getAllItemsPerDate();
    ...
    public DynamicReport buildReport(){
        ...
        .setTitle("RMS - Media Purchases Report")
        ...
        for(int i=0; i<getNumberOfSubreports();i++){
            MediaPurchasesSubReport mediaPurchasesSubReport = BeansClass.mediaPurchasesSubReport();
            DynamicReport subReport;
            try {
                subReport = mediaPurchasesSubReport.buildReport(); 
    ...
    public static void main(String[] args) {
        MediaPurchasesReport mr = new MediaPurchasesReport();
        mr.produceReport();
    }
