 ...
 * @author Ian Mburu
 */
public class MediaPurchasesSubReport {
    ...
    public void setup(){
        ...
        AbstractColumn columnQuantity= ColumnBuilder.getNew().setColumnProperty("quantity",Integer.class.getName())
            .setTitle("Quantity").setWidth(30).setStyle(importeStyle)
            .setHeaderStyle(headerStyle).build();
        
        AbstractColumn columnTotal= ColumnBuilder.getNew().setColumnProperty("total",Double.class.getName())
            .setTitle("Total").setWidth(80).setStyle(importeStyle)
            .setHeaderStyle(headerStyle).build();
        ...
        drb.setTitle("RMS - Media Purchases SubReport");
