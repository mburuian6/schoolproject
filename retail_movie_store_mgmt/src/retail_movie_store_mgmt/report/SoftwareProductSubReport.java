 ...
 * @author Ian Mburu
 */
public class SoftwareProductSubReport {
    ...
    public void setup(){
        ...
        drb.setTitleStyle(headerStyle).setTitle("RMS - Software Report");
        ...
        DJChart barChart = instance.buildDualBarChart(columnTitle, columnPrice, columnPriceOptical, "Software Bar-Chart");
        drb.addChart(barChart);
        
//        PieChartBuild pieChartB = BeansClass.pieChartBuild();
//        DJChart pieChart = pieChartB.buildPieChart(columnTitle, columnPrice, "Software Pie-Chart Based on Price");
