...
public class HandleProfileLogic {
    ...
    public String deleteUser(String username){
        ...
        if("admin".equals(user.getUsername())){
            return("Error!Cannot delete admin account as it is primary");
        }
        else if(user.getUsername().equals(User.loggedin.getUsername())){
            return("Error!Cannot delete own account while logged in");
        }
        else{
            //del from db
            ...
            if(del){
                ...
                return("Error deleting!Please contact support for help");
            }
        }
