...
public class HandlePreorderLogic {
    ...
    public void insertPreorder(Preorder preorder){
        PreorderHandle preorderHandle = BeansClass.preorderHandle();
        PreorderManagerController preorderManagerController = BeansClass.preorderManagerController();
        
        boolean checkIfTodoExists = checkIfExists(preorder);
        if(checkIfTodoExists){
            preorderManagerController.displayError("Error!Preorder has already been inserted");
        }
        else{
            boolean insert = preorderHandle.insertToDb(preorder);
            if(insert){
                preorderManagerController.displayInfo("Successful Insertion!");
            }
            else{
                preorderManagerController.displayError("Error!Please contact support for help");
            }
        }
    }
    ...
    public void updatePreorder(Preorder preorder){
        ...
        if(update){
            preorderManagerController.displayInfo("Successful Update!");
        }
        else{
            preorderManagerController.displayError("Error!Please contact support for help");
        }
    ...
    public void updatePreorderStatusToDone(Preorder preorder){
        PreorderHandle preorderHandle = BeansClass.preorderHandle();
        PreorderManagerController preorderManagerController = BeansClass.preorderManagerController();
        
        preorder.setStatus("done");
        boolean update = preorderHandle.updateStatusInDb(preorder);
        if(update){
            preorderManagerController.displayInfo("Successful Update!");
        }
        else{
    ...
    public void revertPreorderStatusToPending(Preorder preorder){
        PreorderHandle preorderHandle = BeansClass.preorderHandle();
        PreorderManagerController preorderManagerController = BeansClass.preorderManagerController();
    ...
    public void deletePreorder(Preorder preorder){
        ...
        if(del){
            preorderManagerController.displayInfo("Successful Deletion!");
        }
        else{
            preorderManagerController.displayError("Error!Please contact support for help");
        }
